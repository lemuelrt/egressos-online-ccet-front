export const MESSAGES = {
  ...
  'M018': 'Importação finalizada!',
  'M019': 'Não foi possível importar o arquivo.',
  'M020': 'Cadastros realizados com sucesso!',
  'M021': 'Ano inválido.',
  // tslint:disable-next-line:max-line-length
  'M022': 'O ano de conclusão deve ser superior ao ano de início da graduação. Deve ser respeitado o tempo mínimo de integralização do curso.',
